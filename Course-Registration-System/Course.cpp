...
Course::Course(string ID, string title, string syllabus, int creditHours, Semester semester) {
    this->ID = ID;
    this->title = title;
...
vector<const Course*> Course::getPrerequisite() const {
...
void Course::displayCourseInfo() const {
    cout << "\n\nCourse Managing:\n==============================\n";
    cout << "1 : Course ID: " << this->ID << endl;
    cout << "2 : Course Name: " << this->title << endl;
    cout << "3 : Course Syllabus: " << this->syllabus << endl;
    cout << "4 : Course semester: " << (this->semester ? "Spring" : "Fall") << endl;
    cout << "5 : Required Credit Hours: " << this->creditHours << endl;
    cout << "6 : Instructors: [ ";
    for (auto& it : this->instructors) {
        cout << it->name << " ";
    }
    cout << "]\n";
    cout << "7 : Prerequisites: [ ";
    for (auto& it : this->prerequisites) {
        cout << it->getTitle() << " ";
    }
    cout << "]\n";
    cout << "8 : Required Majors: [ ";
    for (auto& it : this->reqMajor) {
        cout << it << " ";
    }
    cout << "]\n";
    cout << "=================================================================\n";
